                ...
                <div class="row">
                  <div class="col-md-12">
                    <fieldset class="form-group">
                      ...
                      <img style="width: 50px; height: 50px;" src="<?php echo base_url('/assets/front/images/donasi/'.$rows->img1); ?>" />
                      <input class="form-control-file" value="<?php echo $rows->img1; ?>" name="gambar" id="file" type="file">
                    </fieldset>
                  </div>
                </div>
