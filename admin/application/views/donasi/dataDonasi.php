...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content container-fluid">
            <div class="row">
                <div class="col-md-12">
                <a class="btn btn-primary btn-block" style="margin-bottom: 5px;" href="<?php echo base_url('admin/donasi/add'); ?>">Tambah Data Donasi</a>
                    <div class="chart-box">
                        <h4>Data Donasi</h4>
                            ...
                            <table class="table table-bordered">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img style="width: 50px; height: 50px;" src="<?php echo base_url('assets/front/images/donasi/'.$rows->img1); ?>" /></td>
                                        <td>
