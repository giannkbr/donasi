...
<body class="sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<section class="content container-fluid">
				<div class="col-md-12">
					...
					<a class="btn btn-primary btn-block" href="<?php echo base_url('admin/donasi'); ?>">Data Donasi</a>
					<form action="<?php echo base_url('admin/Donasi/create'); ?>" method="post" class="chart-box" style="margin-top: 5px;" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-12">
								<fieldset class="form-group">
									...
									<textarea class="form-control" name="deskripsi_donasi" id="basicInput" type="text"
										required></textarea>
								</fieldset>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
								<fieldset class="form-group">
									...
									<input class="form-control-file" name="img1" id="basicInput" type="file"/>
								</fieldset>
							</div>
						</div>
	...
	<script type="text/javascript"
		src="<?php echo base_url('assets/bower_components/jquery-maskmoney/dist/jquery.maskMoney.min.js'); ?>"></script>
